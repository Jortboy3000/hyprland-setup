...
{\*\expandedcolortbl;;}
\paperw11900\paperh16840\margl1440\margr1440\vieww25180\viewh26880\viewkind0
...
\
    ...
    "network": \{\
        ...
        "format-disconnected": "Disconnected \uc0\u9888 ",\
...
# === SUCCESS MESSAGE ===\
echo\
echo -e "$\{GREEN\}\uc0\u9989  Hyprland setup completed successfully!$\{NC\}"\
echo\
echo -e "$\{BLUE\}\uc0\u55357 \u56513  Backup created at:$\{NC\} $BACKUP_DIR"\
echo -e "$\{BLUE\}\uc0\u55357 \u56764 \u65039   Default wallpaper:$\{NC\} $WALLPAPER_PATH"\
echo\
echo -e "$\{YELLOW\}\uc0\u55356 \u57263  Key bindings:$\{NC\}"\
echo "  Super + Enter       \uc0\u8594  Terminal"\
echo "  Super + D           \uc0\u8594  Application launcher"\
echo "  Super + Q           \uc0\u8594  Close window"\
echo "  Super + M           \uc0\u8594  Exit Hyprland"\
echo "  Super + 1-0         \uc0\u8594  Switch workspace"\
echo "  Super + Shift + 1-0 \uc0\u8594  Move window to workspace"\
echo "  Super + Print       \uc0\u8594  Screenshot selection"\
echo "  Print               \uc0\u8594  Screenshot full screen"\
echo\
echo -e "$\{GREEN\}\uc0\u55357 \u56960  Reboot now to enter your new Hyprland environment!$\{NC\}"\
echo -e "$\{BLUE\}\uc0\u55357 \u56481  Tip:$\{NC\} You can customize your wallpaper by placing images in ~/Pictures/wallpapers/"\
EOF}